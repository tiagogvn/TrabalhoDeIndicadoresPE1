...
Indicadores_de_Mortalidade_para_benefício_social.pdf: Neste arquivo será encontrada a versão final compilada do relatório, com todos os indicadores, suas relevâncias e modos de calcular.
